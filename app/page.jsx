  ...
  return (
    <div className="bg-transparent overflow-x-hidden">
      ...
      <section className="pt-28 sm:pt-32 relative min-h-screen grid grid-cols-1 lg:grid-cols-5 px-4 sm:px-8 pb-20 overflow-hidden">
        {/* The global StarsBackground is applied in app/layout.js to cover the entire page background */}
        ...
        <div className="col-span-full lg:col-span-3 flex flex-col items-center justify-center text-center lg:-rotate-2">
          ...
          <div className="relative flex items-center justify-center gap-3 sm:gap-4 mt-8 sm:mt-16">
            ...
            <p className="text-sm text-stone-500 text-center sm:text-left">
              <strong className="text-stone-400 font-medium">2,400+ engineers
              </strong>{" "}
        ...
        <div className="col-span-full lg:col-span-2 flex items-center justify-center lg:justify-start mt-12 lg:mt-0 lg:rotate-2">
      ...
      <section className="relative z-10 pb-28 max-w-5xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <SectionHeading gray="Built for both sides " gold="of the table"></SectionHeading>

        </div>
        <div className="grid md:grid-cols-2 gap-6">
          {ROLES.map(
            role => (
              <div key={role.label} className="relative bg-[#0f0f11] border border-white/10 hover:border-amber-400/20 rounded-2xl p-12 h-full transition duration-300 overflow-hidden">
      ...
      <section className="relative z-10 pb-28 max-w-5xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-stone-400 mt-3 text-sm">Each Credit = one Session. Unused credits roll over.
      ...
      <section className="relative z-10 pb-28 max-w-5xl mx-auto px-6">
        <div className="relative border border-white/10 rounded-3xl px-4 sm:px-16 py-20 sm:py-24 bg-[#0a0a0c]/85 backdrop-blur-md text-center overflow-hidden">
          <GravityStarsBackground className="absolute inset-0 -z-10 w-full h-full" />
          ...
          <div className="relative z-10 flex flex-col sm:flex-row justify-center items-center gap-4">
            ...
            <Link href="/explore">
              <Button variant="outline" size="hero" className="bg-white/5 border border-white/10 hover:bg-white/10 text-white transition duration-200">
                Browse Interviewers →
              </Button>
            </Link>
          </div>
