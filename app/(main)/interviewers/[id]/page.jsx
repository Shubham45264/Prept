...
const InterviewerProfilePage = async ({ params }) => {
  ...
  return (
    <main className="min-h-screen bg-black ">
      <section className="relative border-b border-white/8 overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-8 pt-20 pb-14 flex flex-col gap-8">
          ...
          <div className="flex items-start gap-8">
            <Avatar className="w-32 h-24 border-2 border-white/10 shrink-0 rounded-2xl">
              <AvatarImage
      ...
      <div className="max-w-6xl mx-auto px-6 py-12 grid grid-cols-1 lg:grid-cols-5 gap-10 items-start">
        {/* {left} */}
