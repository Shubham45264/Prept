...
const ADMIN_EMAIL = "shubhamjamdar264@gmail.com";
...
export const getAvailability = async () => {
  ...
  return db.avaliability.findFirst({
    where: { interviewerId: dbUser.id, status: "AVAILABLE" },
  });
};
...
export const getInterviewerStats = async () => {
  ...
  const totalEarned = dbUser.bookingAsInterviewer.reduce(
